...
namespace Inventory.InventoryDataSetTableAdapters {
    ...
    public partial class inventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[inventory] WHERE (([del_inv] = @Original_del_inv) AND ([invNum] = @Original_invNum) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_serialNum = 1 AND [serialNum] IS NULL) OR ([serialNum] = @Original_serialNum)) AND ((@IsNull_user = 1 AND [user] IS NULL) OR ([user] = @Original_user)) AND ([add_inv] = @Original_add_inv) AND ((@IsNull_ipaddress = 1 AND [ipaddress] IS NULL) OR ([ipaddress] = @Original_ipaddress)) AND ((@IsNull_computername = 1 AND [computername] IS NULL) OR ([computername] = @Original_computername)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_cost = 1 AND [cost] IS NULL) OR ([cost] = @Original_cost)))";
...
SELECT del_inv, invNum, name, date, serialNum, [user], add_inv, ipaddress, computername, type, cost FROM inventory WHERE (invNum = @invNum)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[inventory] SET [del_inv] = @del_inv, [invNum] = @invNum, [name] = @name, [date] = @date, [serialNum] = @serialNum, [user] = @user, [add_inv] = @add_inv, [ipaddress] = @ipaddress, [computername] = @computername, [type] = @type, [cost] = @cost WHERE (([del_inv] = @Original_del_inv) AND ([invNum] = @Original_invNum) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_serialNum = 1 AND [serialNum] IS NULL) OR ([serialNum] = @Original_serialNum)) AND ((@IsNull_user = 1 AND [user] IS NULL) OR ([user] = @Original_user)) AND ([add_inv] = @Original_add_inv) AND ((@IsNull_ipaddress = 1 AND [ipaddress] IS NULL) OR ([ipaddress] = @Original_ipaddress)) AND ((@IsNull_computername = 1 AND [computername] IS NULL) OR ([computername] = @Original_computername)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_cost = 1 AND [cost] IS NULL) OR ([cost] = @Original_cost)));
SELECT del_inv, invNum, name, date, serialNum, [user], add_inv, ipaddress, computername, type, cost FROM inventory WHERE (invNum = @invNum)";
        ...
        public virtual int Delete(global::System.Nullable<bool> Original_del_inv, string Original_invNum, string Original_name, string Original_date, string Original_serialNum, string Original_user, global::System.Nullable<bool> Original_add_inv, string Original_ipaddress, string Original_computername, string Original_type, global::System.Nullable<double> Original_cost) {
            if ((Original_del_inv.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((bool)(Original_del_inv.Value));
            }
            else {
            ...
            if ((Original_invNum == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_invNum));
            }
            ...
            if ((Original_add_inv.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[10].Value = ((bool)(Original_add_inv.Value));
            }
            else {
            ...
            if ((Original_ipaddress == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_ipaddress));
            }
        ...
        public virtual int Update(
            ...
            if ((Original_del_inv.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_del_inv.Value));
            }
            else {
            ...
            if ((Original_invNum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_invNum));
            }
            if ((Original_name == null)) {
            ...
            if ((Original_serialNum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_serialNum));
            }
            if ((Original_user == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_user));
            }
            if ((Original_add_inv.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[21].Value = ((bool)(Original_add_inv.Value));
            }
            else {
            ...
            if ((Original_ipaddress == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_ipaddress));
            }
            if ((Original_computername == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((string)(Original_computername));
            }
            if ((Original_type == null)) {
            ...
            if ((Original_cost.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((double)(Original_cost.Value));
            }
            else {
